 ...
 * 
 */
public class GoogleContactParameters {
	 ...
	 */
	private SortedMap<String, String> parameterValueMap = new TreeMap<String,String>();
	 ...
	 */
	public GoogleContactParameters(GoogleContactParameters commandLineParams, String scriptLine) {
	 ...
	 */
	public GoogleContactParameters(String arguments[]) {
		fillFromArguments(arguments);
	}

	public GoogleContactParameters() {
		parameterValueMap.put(ParameterNames.USERNAME.getParameterName(), "df12contactsync@gmail.com");
		parameterValueMap.put(ParameterNames.PASSWORD.getParameterName(), "Dt3xJ763");
	}
